...
// Maybe these should be methods on CodePairValue?
//
// I'd call them "assert_bool", "assert_long", etc
...
// since this is only really used in autogenerated code, I'd give it a really
// explicit name.  Maybe do doc(hidden) too?
...
// I'm pretty sure there's a hex-string to int conversion already
// available in the stdlib.  Can't check because train :(
...
// all of these functions should probably be impls of Display on the enum type
